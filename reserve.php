...
mysql_select_db($database_cn_tanzi, $cn_tanzi);
$query_cn_reserve = "SELECT * FROM reserve ORDER BY Id DESC";
$cn_reserve = mysql_query($query_cn_reserve, $cn_tanzi) or die(mysql_error());
$row_cn_reserve = mysql_fetch_assoc($cn_reserve);
$totalRows_cn_reserve = mysql_num_rows($cn_reserve);
?>
<!doctype html>
<html>
            ...
            <div id="collapse4" class="body">
                    ...
                    <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td><?php echo $i; $i++; ?></td>
                          <td><?php echo $row_cn_reserve['Reserve_property']; ?></td>
                          <td><?php echo $row_cn_reserve['Date']; ?></td>
                          <td><?php echo $row_cn_reserve['Time']; ?></td>
                          <td><?php echo $row_cn_reserve['Member']; ?></td>
                          <td><a href="reserve_del.php?Id=<?php echo $row_cn_reserve['Id']; ?>">刪除</a></td>
                        </tr>
                        <?php } while ($row_cn_reserve = mysql_fetch_assoc($cn_reserve)); ?>
                  </tbody>                </table>
