...
mysql_select_db($database_cn_tanzi, $cn_tanzi);
$query_cn_package = "SELECT * FROM package ORDER BY Member_id ASC";
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/less.js/2.7.1/less.js"></script>
        ...
        <div class="box">
            <header>
              ...
              <h5>綜合查詢-包裹、郵件</h5>
              <h5><a href="package_add.php">新增</a></h5>
            </header>
            <div id="collapse4" class="body">
                    ...
                    <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td><?php echo $i; $i++; ?></td>
                          <td><?php echo $row_cn_package['Member_id']; ?></td>
                          <td><?php echo $row_cn_package['Package_mail']; ?></td>
                          <td><?php echo $row_cn_package['Delivery_company']; ?></td>
                          <td><?php echo $row_cn_package['Date']; ?></td>
                          <td><?php echo $row_cn_package['Detail']; ?></td>
                          <td><a href="package_edit.php?Id=<?php echo $row_cn_package['Id']; ?>">修改</a></td>
                          <td><a href="inquire_del.php?Id=<?php echo $row_cn_package['Id']; ?>">刪除</a></td>
                        </tr>
                        <?php } while ($row_cn_package = mysql_fetch_assoc($cn_package)); ?>
                  </tbody>                </table>
            ...
            <div id="collapse4" class="body">
                    ...
                    <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td><?php echo $i; $i++; ?></td>
                          <td><?php echo $row_cn_member['Login_id']; ?></td>
                          <td><?php echo $row_cn_member['Management_fee']; ?></td>
                          <td><?php echo $row_cn_member['Paid_management_fee']; ?></td>
                          <td><?php echo $row_cn_member['Money_collection_person']; ?></td>
                          <td><?php echo $row_cn_member['Paid_date']; ?></td>
                          <td><a href="management_fee_edit.php?Id=<?php echo $row_cn_member['Id']; ?>">修改</a></td>
                          
                        </tr>
                        <?php } while ($row_cn_member = mysql_fetch_assoc($cn_member)); ?>
                  </tbody>                </table>
