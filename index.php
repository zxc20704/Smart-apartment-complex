...
if (isset($_POST['Login_id'])) {
  ...
  $MM_redirectLoginSuccess = "index_member.php";
  $MM_redirectLoginFailed = "index.php";
  $MM_redirecttoReferrer = false;
  mysql_select_db($database_cn_tanzi, $cn_tanzi);
  
  $LoginRS__query=sprintf("SELECT Login_id, Password FROM member WHERE Login_id=%s AND Password=%s",
...
<?php
   if(isset($_GET['Go_home'])){
		...
		echo "<script>alert('謝謝光臨，歡迎下次再來'); location.href='index.php';</script>";	
       }
    ?>
<?php 

$sql=mysql_query("SELECT * FROM `house` WHERE `Project`='1' "); 
...
<div id="article" class="container">
           <img  src="travel/10.jpg">
            ...
            <form ACTION="<?php echo $loginFormAction; ?>" METHOD="POST" id="login1">
                ...
                <input name="Login_id" type="text"  id="Login_id" placeholder="用戶帳號">
                <input name="Password" type="password"  id="Password" placeholder="登入密碼">
                <div class="checkbox">
		  		<br>
		</div>
...
<br>
             <span class="titleMore1"><a href="container3.php">More</a></span>
          </div>
