...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "thing_edit")) {
  $updateSQL = sprintf("UPDATE thing SET Title=%s, `Date`=%s, Thing=%s, Detail=%s WHERE Id=%s",
                       GetSQLValueString($_POST['Title'], "text"),
                       GetSQLValueString($_POST['Date'], "date"),
                       GetSQLValueString($_POST['Thing'], "text"),
...
$colname_cn_thing = "-1";
if (isset($_GET['Id'])) {
  $colname_cn_thing = $_GET['Id'];
}
mysql_select_db($database_cn_tanzi, $cn_tanzi);
$query_cn_thing = sprintf("SELECT * FROM thing WHERE Id = %s", GetSQLValueString($colname_cn_thing, "int"));
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/less.js/2.7.1/less.js"></script>
        ...
        <div class="box">
            ...
            <div id="collapse4" class="body">
              <form action="<?php echo $editFormAction; ?>" id="thing_edit" name="thing_edit" method="POST">
                <table width="70%" border="0" cellspacing="0" cellpadding="0">
                  <tbody>
                    <tr>
                      <td><label for="Title">標題:</label>
                      <input name="Title" type="text" id="Title" value="<?php echo $row_cn_thing['Title']; ?>"></td>
                    </tr>
                     <tr>
                      <td><label for="Date">發布日期:</label>
                      <input name="Date" type="text" id="Date" value="<?php echo $row_cn_thing['Date']; ?>"></td>
                    </tr>
                    <tr>
                      <td><label for="Ting">備註(顯示在公佈欄):</label>
                      <input name="Thing" type="text" id="Thing" value="<?php echo $row_cn_thing['Thing']; ?>"></td>
                    </tr>
                    <tr>
                      <td><label for="Detail">公告訊息:</label>
                      <textarea id="Detail" class="ckeditor" name="Detail" value="<?php echo $row_cn_thing['Detail']; ?>"><?php echo $row_cn_thing['Detail']; ?></textarea>
                ...
                <input name="Id" type="hidden" id="Id" form="thing_edit" value="<?php echo $row_cn_thing['Id']; ?>">
