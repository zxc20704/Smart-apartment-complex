...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "thing_add")) {
  $insertSQL = sprintf("INSERT INTO thing (Title, `Date`, Thing, Detail) VALUES (%s, %s, %s, %s)",
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/less.js/2.7.1/less.js"></script>
        ...
        <div class="box">
            ...
            <div id="collapse4" class="body">
              <form action="<?php echo $editFormAction; ?>" id="thing_add" name="thing_add" method="POST">
                <table width="70%" border="0" cellspacing="0" cellpadding="0">
                  <tbody>
                    ...
                    <tr>
                      <td><label for="Thing">備註:</label>
                      <input type="text" name="Thing" id="Thing"></td>
                    </tr>
                    <tr>
                      <td><label for="Detail">公告細節(顯示在公告訊息中):</label>
                      <textarea id="Detail" class="ckeditor" name="Detail"></textarea>
                ...
                <p>&nbsp;</p>
                <input type="hidden" name="MM_insert" value="thing_add">
              </form>
              <p>&nbsp;</p>
