...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "home_footer_edit")) {
  $updateSQL = sprintf("UPDATE home_footer SET Name=%s, Phone=%s, E_mail=%s, Address=%s WHERE Id=%s",
  ...
  $updateGoTo = "index_home_footer.php";
  if (isset($_SERVER['QUERY_STRING'])) {
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/less.js/2.7.1/less.js"></script>
        ...
        <div class="box">
            ...
            <div id="collapse4" class="body">
              <form action="<?php echo $editFormAction; ?>" id="home_footer_edit" name="home_footer_edit" method="POST">
                <table width="70%" border="0" cellspacing="0" cellpadding="0">
                  <tbody>
                    <tr>
                      <td><label for="Name">社區名稱:</label>
                      <input name="Name" type="text" id="Name" value="<?php echo $row_cn_home_footer['Name']; ?>"></td>
                    </tr>
                    <tr>
                      <td><label for="Phone">連絡電話:</label>
                      <input name="Phone" type="text" id="Phone" value="<?php echo $row_cn_home_footer['Phone']; ?>"></td>
                    </tr>
                     <tr>
                      <td><label for="E_mail">電子信箱:</label>
                      <input name="E_mail" type="text" id="E_mail" value="<?php echo $row_cn_home_footer['E_mail']; ?>"></td>
                    </tr>
                     <tr>
                      <td><label for="Address">社區地址:</label>
                      <input name="Address" type="text" id="Address" value="<?php echo $row_cn_home_footer['Address']; ?>"></td>
                    </tr>
                ...
                <input name="Id" type="hidden" id="Id" form="home_footer_edit" value="<?php echo $row_cn_home_footer['Id']; ?>">
                
                <input type="hidden" name="MM_update" value="home_footer_edit">
              </form>
              <p>&nbsp;</p>
