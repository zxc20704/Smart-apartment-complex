...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "member_edit")) {
  $updateSQL = sprintf("UPDATE member_photo SET Login_id=%s, Password=%s, Name=%s WHERE Id=%s",
        ...
        <div class="box">
           ...
           <tbody>
            ...
            <footer class="Footer bg-dark dker">
                <p>Copyright © 2018 &nbsp;<?php echo $row_cn_home_footer['Name']; ?>社區. &nbsp;All rights reserved.</p>
            </footer>
            <!-- /#footer -->
            <!-- #helpModal -->
