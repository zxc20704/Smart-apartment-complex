...
mysql_select_db($database_cn_tanzi, $cn_tanzi);
$query_cn_house = "SELECT * FROM house ORDER BY Id ASC";
...
<div class="btn-group">
        ...
        <div class="box">
            <header>
              ...
              <h5>房屋出租管理-房屋出租詳細頁面資訊</h5>
              <h5><a href="house_manage_detail.php">房屋出租首頁資訊</a></h5>
              <h5><a href="house_manage_img.php">房屋圖片</a></h5>
            </header>
            <div id="collapse4" class="body">
                  ...
                  <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                    ...
                    <?php $i=1; do { 
                      ...
                      <tr>
                        <td><?php echo $i; $i++;?></td>
                        <td><?php echo $row_cn_house['Title']; ?></td>
                        <td><?php echo $row_cn_house['Name']; ?></td>
                        <td><?php echo $row_cn_house['Phone']; ?></td>
                        <td><?php echo $row_cn_house['Line_id']; ?></td>
                        <td><?php echo $row_cn_house['Date']; ?></td>
                        <td><?php echo $row_cn_house['Detail']; ?></td>
                        <td><a href="house_edit.php?Id=<?php echo $row_cn_house['Id']; ?>">修改</a></td>
                        <td><a href="house_del.php?Id=<?php echo $row_cn_house['Id']; ?>">刪除</a></td>
                        </tr>
                    <?php } while ($row_cn_house = mysql_fetch_assoc($cn_house)); ?>  
                      </tbody>                </table>
