    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/less.js/2.7.1/less.js"></script>
        ...
        <div class="box">
            <header>
              ...
              <h5>公告訊息&nbsp;(首頁公佈欄的詳細版本)</h5>
              <h5><a href="announcement_add.php">新增</a></h5>
            </header>
                    ...
                    <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo $row_cn_thing['Detail']; ?></td>
                          <td><a href="announcement_edit.php?Id=<?php echo $row_cn_thing['Id']; ?>">修改</a></td>
                          <td><a href="announcement_del.php?Id=<?php echo $row_cn_thing['Id']; ?>">刪除</a></td>
                        </tr>
