...
mysql_select_db($database_cn_tanzi, $cn_tanzi);
$query_cn_votetitle = "SELECT * FROM votetitle ORDER BY titleNo ASC";
$cn_votetitle = mysql_query($query_cn_votetitle, $cn_tanzi) or die(mysql_error());
$row_cn_votetitle = mysql_fetch_assoc($cn_votetitle);
$totalRows_cn_votetitle = mysql_num_rows($cn_votetitle);

mysql_select_db($database_cn_tanzi, $cn_tanzi);
$query_cn_votemain = "SELECT * FROM votemain ORDER BY titleNo DESC";
$cn_votemain = mysql_query($query_cn_votemain, $cn_tanzi) or die(mysql_error());
$row_cn_votemain = mysql_fetch_assoc($cn_votemain);
$totalRows_cn_votemain = mysql_num_rows($cn_votemain);
?>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/less.js/2.7.1/less.js"></script>
        ...
        <div class="box">
            <header>
              ...
              <h5>投票系統-投票主題</h5>
              <h5><a href="votetitle_add.php">新增</a></h5>
            </header>
            <div id="collapse4" class="body">
                    ...
                    <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                      ...
                      <tbody>
                        <?php do { ?>
                        <tr>
                          <td><?php echo $row_cn_votetitle['titleNo']; ?></td>
                          <td><?php echo $row_cn_votetitle['voteTitle']; ?></td>
                          <td><?php echo $row_cn_votetitle['startDate']; ?></td>
                          <td><?php echo $row_cn_votetitle['endDate']; ?></td>
                          <td><a href="votetitle_edit.php?titleNo=<?php echo $row_cn_votetitle['titleNo']; ?>">修改</a></td>
                          <td><a href="votetitle_del.php?titleNo=<?php echo $row_cn_votetitle['titleNo']; ?>">刪除</a></td>
                        </tr>
                        <?php } while ($row_cn_votetitle = mysql_fetch_assoc($cn_votetitle)); ?>
                  </tbody>                </table>
        ...
        <div class="box">
            <header>
                <div class="icons"><i class="fa fa-table"></i></div>
              <h5>投票系統-投票選項</h5>
              <h5><a href="votemain_add.php">新增</a></h5>
            </header>
            <div id="collapse4" class="body">
                    ...
                    <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                      ...
                      <tbody>
                        <?php $i=1; do { 
						$titleno=$row_cn_votemain['titleNo'];  
                        $sql=mysql_query("SELECT * FROM `votetitle` WHERE `titleNo`= $titleno"); 
                        $row=mysql_fetch_array($sql);

						  ?>
                        <tr>
                          <td><?php echo $i; $i++;?></td>
                          <td><?php echo $row['voteTitle']; ?></td>
                          <td><?php echo $row_cn_votemain['itemName']; ?></td>
                          <td><?php echo $row_cn_votemain['itemNum']; ?></td>
                          <td><a href="votemain_del.php?itemNo=<?php echo $row_cn_votemain['itemNo']; ?>">刪除</a></td>
                        </tr>
                        <?php } while ($row_cn_votemain = mysql_fetch_assoc($cn_votemain)); ?>
                  </tbody>                </table>
...
mysql_free_result($cn_votetitle);

mysql_free_result($cn_votemain);
?>
