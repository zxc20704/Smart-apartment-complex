...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "rules_add")) {
  $insertSQL = sprintf("INSERT INTO rules (Title, Article) VALUES (%s, %s)",
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/less.js/2.7.1/less.js"></script>
        ...
        <div class="box">
            ...
            <div id="collapse4" class="body">
              <form action="<?php echo $editFormAction; ?>" id="rules_add" name="rules_add" method="POST">
                <table width="70%" border="0" cellspacing="0" cellpadding="0">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <input type="text" name="Article" id="Article"></td>
                ...
                <p>&nbsp;</p>
                <input type="hidden" name="MM_insert" value="rules_add">
              </form>
              <p>&nbsp;</p>
