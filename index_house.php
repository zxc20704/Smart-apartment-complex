        ...
        <div class="box">
            ...
            <div id="collapse4" class="body">
                  ...
                  <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                    ...
                    <?php do { ?>
                      <tr>
                        <td><?php echo $row_cn_house['Id']; ?></td>
                        ...
                        <td><?php echo $row_cn_house['Project']; ?></td>
                        <td><a href="index_house_edit.php?Id=<?php echo $row_cn_house['Id']; ?>">修改</a></td>
