...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "social_introduction_edit")) {
  $updateSQL = sprintf("UPDATE social_introduction SET Img=%s, Title=%s, Article=%s WHERE Id=%s",
...
$colname_cn_social_introduction = "-1";
if (isset($_GET['Id'])) {
  $colname_cn_social_introduction = $_GET['Id'];
}
mysql_select_db($database_cn_tanzi, $cn_tanzi);
$query_cn_social_introduction = sprintf("SELECT * FROM social_introduction WHERE Id = %s", GetSQLValueString($colname_cn_social_introduction, "int"));
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/less.js/2.7.1/less.js"></script>
        ...
        <div class="box">
            ...
            <div id="collapse4" class="body">
              <form action="<?php echo $editFormAction; ?>" id="social_introduction_edit" name="social_introduction_edit" method="POST">
                <table width="70%" border="0" cellspacing="0" cellpadding="0">
                  <tbody>
                    <tr>
                      <td><label for="Img">圖片:</label>
                      <input name="Img" type="text" id="Img" value="<?php echo $row_cn_social_introduction['Img']; ?>"></td>
                    </tr>
                    <tr>
                      <td><label for="Title">標題:</label>
                      <input name="Title" type="text" id="Title" value="<?php echo $row_cn_social_introduction['Title']; ?>"></td>
                    </tr>
                     <tr>
                      <td><label for="Article">文章內容:</label>
                      <textarea id="Article" class="ckeditor" name="Article" value="<?php echo $row_cn_social_introduction['Article']; ?>"><?php echo $row_cn_social_introduction['Article']; ?></textarea>
                ...
                <input name="Id" type="hidden" id="Id" form="social_introduction_edit" value="<?php echo $row_cn_social_introduction['Id']; ?>">
                
                <input type="hidden" name="MM_update" value="social_introduction_edit">
              </form>
              <p>&nbsp;</p>
