...
mysql_select_db($database_cn_tanzi, $cn_tanzi);
$query_cn_fix = "SELECT * FROM fix ORDER BY Id DESC";
                    ...
                    <nav class="navbar navbar-inverse navbar-static-top">
                        <div class="container-fluid">
                            ...
                            <div class="topnav">
                                ...
                                <div class="btn-group"><a href="../../index.php" data-toggle="tooltip" data-original-title="Logout" data-placement="bottom" class="btn btn-metis-1 btn-sm"> <em class="fa fa-power-off"></em> </a></div>
                                <div class="btn-group">
            ...
            <div id="collapse4" class="body">
                    ...
                    <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td><?php echo $i; $i++; ?></td>
                          <td><?php echo $row_cn_fix['Name']; ?></td>
                          <td><?php echo $row_cn_fix['Location']; ?></td>
                          <td><?php echo $row_cn_fix['Date']; ?></td>
                          <td><?php echo $row_cn_fix['Member']; ?></td>
                          <td><?php echo $row_cn_fix['Detail']; ?></td>
                          <td><a href="fix_edit.php?Id=<?php echo $row_cn_fix['Id']; ?>">修改</a></td>
                          <td><a href="fix_del.php?Id=<?php echo $row_cn_fix['Id']; ?>">刪除</a></td>
                        </tr>
                        <?php } while ($row_cn_fix = mysql_fetch_assoc($cn_fix)); ?>
                  </tbody>                </table>
