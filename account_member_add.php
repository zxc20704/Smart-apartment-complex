...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "member_add")) {
  $insertSQL = sprintf("INSERT INTO member (Login_id, Password, Name) VALUES (%s, %s, %s)",
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/less.js/2.7.1/less.js"></script>
        ...
        <div class="box">
            ...
            <div id="collapse4" class="body">
              <form action="<?php echo $editFormAction; ?>" id="member_add" name="member_add" method="POST">
                <table width="70%" border="0" cellspacing="0" cellpadding="0">
                  <tbody>
                    <tr>
                      <td><label for="Title">用戶帳號:</label>
                      <input type="text" name="Login_id" id="Login_id"></td>
                    </tr>
                    <tr>
                      <td><label for="Thing">用戶密碼:</label>
                      <input type="text" name="Password" id="Password"></td>
                    </tr>
                    <tr>
                      <td><label for="Thing">用戶暱稱:</label>
                ...
                <p>&nbsp;</p>
                <input type="hidden" name="MM_insert" value="member_add">
              </form>
              <p>&nbsp;</p>
