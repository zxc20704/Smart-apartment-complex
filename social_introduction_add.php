...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "social_introduction_add")) {
  $insertSQL = sprintf("INSERT INTO social_introduction (Img, Title, Article) VALUES (%s, %s, %s)",
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/less.js/2.7.1/less.js"></script>
        ...
        <div class="box">
            ...
            <div id="collapse4" class="body">
              <form action="<?php echo $editFormAction; ?>" id="social_introduction_add" name="social_introduction_add" method="POST">
                <table width="70%" border="0" cellspacing="0" cellpadding="0">
                  <tbody>
                    <tr>
                      <td><label for="Img">圖片:</label>
                      <input type="text" name="Img" id="Img"></td>
                    </tr>
                    <tr>
                     ...
                     <tr>
                      ...
                      <textarea id="Article" class="ckeditor" name="Article"></textarea>
                ...
                <p>&nbsp;</p>
                <input type="hidden" name="MM_insert" value="social_introduction_add">
              </form>
              <p>&nbsp;</p>
