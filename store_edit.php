...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "store_edit")) {
  $updateSQL = sprintf("UPDATE store SET Img=%s, Name=%s WHERE Id=%s",
...
$colname_cn_store = "-1";
if (isset($_GET['Id'])) {
  $colname_cn_store = $_GET['Id'];
}
mysql_select_db($database_cn_tanzi, $cn_tanzi);
$query_cn_store = sprintf("SELECT * FROM store WHERE Id = %s", GetSQLValueString($colname_cn_store, "int"));
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/less.js/2.7.1/less.js"></script>
        ...
        <div class="box">
            ...
            <div id="collapse4" class="body">
              <form action="<?php echo $editFormAction; ?>" id="store_edit" name="store_edit" method="POST">
                <table width="70%" border="0" cellspacing="0" cellpadding="0">
                  <tbody>
                    <tr>
                      <td><label for="Img">圖片:</label>
                      <input name="Img" type="text" id="Img" value="<?php echo $row_cn_store['Img']; ?>"></td>
                    </tr>
                    <tr>
                      <td><label for="Name">商店名稱:</label>
                      <input name="Name" type="text" id="Name" value="<?php echo $row_cn_store['Name']; ?>"></td>
                    </tr>
                ...
                <input name="Id" type="hidden" id="Id" form="store_edit" value="<?php echo $row_cn_store['Id']; ?>">
                
                <input type="hidden" name="MM_update" value="store_edit">
              </form>
              <p>&nbsp;</p>
