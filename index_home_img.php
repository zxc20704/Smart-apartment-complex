    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/less.js/2.7.1/less.js"></script>
        ...
        <div class="box">
            <header>
              ...
              <h5>圖片</h5>
              <h5><a href="index_home_img_add.php">新增</a></h5>
            </header>
            <div id="collapse4" class="body">
                    ...
                    <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td><?php echo $i; $i++; ?></td>
                          <td><?php echo $row_cn_home_img['Img']; ?></td>
                          <td><?php echo $row_cn_home_img['Img_name']; ?></td>
                          
                          <td><a href="index_home_img_edit.php?Id=<?php echo $row_cn_home_img['Id']; ?>">修改</a></td>
                          <td><a href="index_home_img_del.php?Id=<?php echo $row_cn_home_img['Id']; ?>">刪除</a></td>
                        </tr>
