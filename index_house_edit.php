...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "house_edit")) {
  $updateSQL = sprintf("UPDATE house SET Title=%s, Pings=%s, Price=%s, `Date`=%s, Project=%s WHERE Id=%s",
                    ...
                    <nav class="navbar navbar-inverse navbar-static-top">
                        <div class="container-fluid">
                            ...
                            <header class="navbar-header">
                                ...
                                <a href="index.html" class="navbar-brand"><img src="assets/img/logo.jpg" alt=""></a>
              ...
              <form action="<?php echo $editFormAction; ?>" id="house_edit" name="house_edit" method="POST">
                <table width="70%" border="0" cellspacing="0" cellpadding="0">
                  <tbody>
                    ...
                    <tr>
                      <td><label for="Price">價位:</label>
                      <input name="Price" type="text" id="Price" value="<?php echo $row_cn_house['Price']; ?>"></td>
                    </tr>
                    <tr>
                      <td><label for="Date">發布時間:</label>
                      <input name="Date" type="text" id="Date" value="<?php echo $row_cn_house['Date']; ?>"></td>
                    </tr>
                    <tr>
                      <td><label for="Project">是否刊登在房屋公佈欄:</label>
                      <input name="Project" type="text" id="Project" value="<?php echo $row_cn_house['Project']; ?>"></td>
                    </tr>
