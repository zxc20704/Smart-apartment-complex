...
mysql_select_db($database_cn_tanzi, $cn_tanzi);
$query_cn_thing = "SELECT * FROM thing ORDER BY Id ASC";
            ...
            <div id="collapse4" class="body">
                    ...
                    <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                      ...
                      <tbody>
                        <?php do { ?>
                        <tr>
                          <td><?php echo $row_cn_home_footer['Name']; ?></td>
                          <td><?php echo $row_cn_home_footer['Phone']; ?></td>
                          <td><?php echo $row_cn_home_footer['E_mail']; ?></td>
                          <td><?php echo $row_cn_home_footer['Address']; ?></td>
                          <td><a href="index_home_footer_edit.php?Id=<?php echo $row_cn_home_footer["Id"]; ?>">修改</a></td>
                          
                        <?php } while ($row_cn_home_footer = mysql_fetch_assoc($cn_home_footer)); ?>
                  </tbody>                </table>
