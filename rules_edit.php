...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "rules_edit")) {
  $updateSQL = sprintf("UPDATE rules SET Title=%s, Article=%s WHERE Id=%s",
...
$colname_cn_rules = "-1";
if (isset($_GET['Id'])) {
  $colname_cn_rules = $_GET['Id'];
}
mysql_select_db($database_cn_tanzi, $cn_tanzi);
$query_cn_rules = sprintf("SELECT * FROM rules WHERE Id = %s", GetSQLValueString($colname_cn_rules, "int"));
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/less.js/2.7.1/less.js"></script>
        ...
        <div class="box">
            ...
            <div id="collapse4" class="body">
              <form action="<?php echo $editFormAction; ?>" id="rules_edit" name="rules_edit" method="POST">
                <table width="70%" border="0" cellspacing="0" cellpadding="0">
                  <tbody>
                    <tr>
                      <td><label for="Title">標題:</label>
                      <input name="Title" type="text" id="Title" value="<?php echo $row_cn_rules['Title']; ?>"></td>
                    </tr>
                   
                     <tr>
                      <td><label for="Article">內文:</label>
                      <textarea id="Article" class="ckeditor" name="Article" ><?php echo $row_cn_rules['Article']; ?></textarea>
                ...
                <input name="Id" type="hidden" id="Id" form="rules_edit" value="<?php echo $row_cn_social_introduction['Id']; ?>">
                
                <input type="hidden" name="MM_update" value="rules_edit">
              </form>
              <p>&nbsp;</p>
