...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "property_add")) {
  $insertSQL = sprintf("INSERT INTO property (Name, `Class`, Class_picture, Reserve_property, Project) VALUES (%s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "property_manage.php";
  if (isset($_SERVER['QUERY_STRING'])) {
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/less.js/2.7.1/less.js"></script>
        ...
        <div class="box">
            ...
            <div id="collapse4" class="body">
              <form action="<?php echo $editFormAction; ?>" id="property_add" name="property_add" method="POST">
                <table width="70%" border="0" cellspacing="0" cellpadding="0">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <input type="text" name="Class_picture" id="Class_picture"></td>
                    </tr>
                    <tr>
                      <td><label for="Reserve_property">是否可以預約:</label>
                      <input type="text" name="Reserve_property" id="Reserve_property" placeholder="">&nbsp;[ 1:可以 / 0:不可以 ]</td>
                    </tr>
                    <tr>
                      <td><label for="Project">是否為公共設施簡介的項目:</label>
                      <input type="text" name="Project" id="Project" placeholder="">&nbsp;[ 1:是 / 0:不是 ]</td>
                    </tr>
                ...
                <p>&nbsp;</p>
                <input type="hidden" name="MM_insert" value="property_add">
              </form>
              <p>&nbsp;</p>
