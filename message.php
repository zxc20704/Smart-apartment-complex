...
mysql_select_db($database_cn_tanzi, $cn_tanzi);
$query_cn_board_main = "SELECT * FROM board_main ORDER BY `no` DESC";
            ...
            <div id="collapse4" class="body">
                    ...
                    <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td><?php echo $i; $i++;?></td>
                          <td><?php echo $row_cn_board_main['subject']; ?></td>
                          <td><?php echo $row_cn_board_main['name']; ?></td>
                          <td><?php echo $row_cn_board_main['email']; ?></td>
                          <td><?php echo $row_cn_board_main['content']; ?></td>
                          <td><?php echo $row_cn_board_main['adminans']; ?></td>
                          <td><?php echo $row_cn_board_main['postdate']; ?></td>
                          <td><a href="message_edit.php?no=<?php echo $row_cn_board_main['no']; ?>">回復</a></td>
                          <td><a href="message_del.php?no=<?php echo $row_cn_board_main['no']; ?>">刪除</a></td>
                        </tr>
                        <?php } while ($row_cn_board_main = mysql_fetch_assoc($cn_board_main)); ?>
                  </tbody>                </table>
