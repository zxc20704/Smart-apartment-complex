...
<div class="btn-group">
        ...
        <div class="box">
            <header>
              ...
              <h5>房屋出租管理-房屋圖片</h5>
              <h5><a href="house_manage_detail.php">房屋首頁資訊</a></h5>
              <h5><a href="house_manage_img.php">房屋出租詳細頁面資訊</a></h5>
            </header>
                  ...
                  <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                    ...
                    <?php $i=1; do { 
                      ...
                      <tr>
                        ...
                        <td><?php echo $row_cn_house['IMG_1']; ?></td>
                        <td><?php echo $row_cn_house['IMG_2']; ?></td>
                        <td><?php echo $row_cn_house['IMG_3']; ?></td>
                        <td><?php echo $row_cn_house['IMG_4']; ?></td>
                        <td><?php echo $row_cn_house['IMG_5']; ?></td>
