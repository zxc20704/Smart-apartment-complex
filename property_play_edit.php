...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "play_edit")) {
...
$colname_cn_property_play = "-1";
if (isset($_GET['Id'])) {
  $colname_cn_property_play = $_GET['Id'];
}
mysql_select_db($database_cn_tanzi, $cn_tanzi);
$query_cn_property_play = sprintf("SELECT * FROM property WHERE Id = %s", GetSQLValueString($colname_cn_property_play, "int"));
$cn_property_play = mysql_query($query_cn_property_play, $cn_tanzi) or die(mysql_error());
$row_cn_property_play = mysql_fetch_assoc($cn_property_play);
$totalRows_cn_property_play = mysql_num_rows($cn_property_play);
?>
<!doctype html>
<html>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/less.js/2.7.1/less.js"></script>
        ...
        <div class="box">
            ...
            <div id="collapse4" class="body">
              <form action="<?php echo $editFormAction; ?>" id="play_edit" name="play_edit" method="POST">
                <table width="70%" border="0" cellspacing="0" cellpadding="0">
                  <tbody>
                     <tr>
                      <td><label for="Name">設施名稱:</label>
                      <input type="text" name="Name" id="Name" value="<?php echo $row_cn_property_play['Name']; ?>"></td>
                    </tr>
                     <tr>
                    ...
                    <tr>
                      ...
                      <input type="text" name="Class_picture" id="Class_picture" value="<?php echo $row_cn_property_play['Class_picture']; ?>"></td>
                    </tr>
                    <tr>
                      <td><label for="Reserve_property">是否可以預約:</label>
                      <input type="text" name="Reserve_property" id="Reserve_property" placeholder="" value="<?php echo $row_cn_property_play['Reserve_property']; ?>">&nbsp;[ 1:可以 / 0:不可以 ]</td>
                    </tr>
                    <tr>
                      <td><label for="Project">是否為公共設施簡介的項目:</label>
                      <input type="text" name="Project" id="Project" placeholder="" value="<?php echo $row_cn_property_play['Project']; ?>">&nbsp;[ 1:是 / 0:不是 ]</td>
                    </tr>
                ...
                <input name="Id" type="hidden" id="Id" form="play_edit" value="<?php echo $row_cn_property_play['Id']; ?>">
                <input type="hidden" name="MM_update" value="play_edit">
              </form>
              <p>&nbsp;</p>
...
mysql_free_result($cn_property_play);
?>
