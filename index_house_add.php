...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "house_add")) {
  $insertSQL = sprintf("INSERT INTO house (Title, Pings, Price, `Date`) VALUES (%s, %s, %s, %s)",
                ...
                <table width="70%" border="0" cellspacing="0" cellpadding="0">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <input type="text" name="Pings" id="Pings"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td><label for="Project">是否刊登在房屋出租表:</label>
