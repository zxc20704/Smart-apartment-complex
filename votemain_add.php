...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "votemain_add")) {
  $insertSQL = sprintf("INSERT INTO votemain (titleNo, itemName) VALUES (%s, %s)",
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/less.js/2.7.1/less.js"></script>
        ...
        <div class="box">
            ...
            <div id="collapse4" class="body">
              <form action="<?php echo $editFormAction; ?>" id="votemain_add" name="votemain_add" method="POST">
                <table width="70%" border="0" cellspacing="0" cellpadding="0">
                  <tbody>
                    <tr>
                      <td><label for="titleNo">標題:</label>
                      <input type="text" name="titleNo" id="titleNo">(請填入標題編號!)</td>
                    </tr>
                    <tr>
                      <td><label for="itemName">選項:</label>
                      <input type="text" name="itemName" id="itemName"></td>
                    </tr>
                ...
                <p>&nbsp;</p>
                <input type="hidden" name="MM_insert" value="votemain_add">
              </form>
              <p>&nbsp;</p>
