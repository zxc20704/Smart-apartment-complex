...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "package_add")) {
  $insertSQL = sprintf("INSERT INTO package (Member_id, Package_mail, Delivery_company, `Date`, Detail) VALUES (%s, %s, %s, %s, %s)",
...
$sql=mysql_query("SELECT * FROM `member` WHERE `Login_id`"); 
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/less.js/2.7.1/less.js"></script>
        ...
        <div class="box">
            ...
            <div id="collapse4" class="body">
              <form action="<?php echo $editFormAction; ?>" id="package_add" name="package_add" method="POST">
                <table width="70%" border="0" cellspacing="0" cellpadding="0">
                  <tbody>
                    <tr>
                      <td><label for="Member_id">住戶帳號:</label>
                      <select name="Member_id" type="text"  id="select-form">
                        <option>請選擇</option>
                       <?php do {?>
                        <option><?php echo $row['Login_id']?></option>
                    ...
                    <tr>
                      ...
                      <input type="text" name="Delivery_company" id="Delivery_company"></td>
                    </tr>
                    <tr>
                ...
                <p>&nbsp;</p>
                <input type="hidden" name="MM_insert" value="package_add">
              </form>
              <p>&nbsp;</p>
