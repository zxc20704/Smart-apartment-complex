...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "committee_member_add")) {
  $insertSQL = sprintf("INSERT INTO committee_member (Img, Name, Office) VALUES (%s, %s, %s)",
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/less.js/2.7.1/less.js"></script>
        ...
        <div class="box">
            ...
            <div id="collapse4" class="body">
              <form action="<?php echo $editFormAction; ?>" id="committee_member_add" name="committee_member_add" method="POST">
                <table width="70%" border="0" cellspacing="0" cellpadding="0">
                  <tbody>
                    ...
                    <tr>
                     ...
                     <input type="text" name="Office" id="Office"></td>
                    </tr>
                ...
                <p>&nbsp;</p>
                <input type="hidden" name="MM_insert" value="committee_member_add">
              </form>
              <p>&nbsp;</p>
