...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "management_fee_edit")) {
  $updateSQL = sprintf("UPDATE member SET Login_id=%s, Management_fee=%s, Paid_management_fee=%s, Money_collection_person=%s, Paid_date=%s WHERE Id=%s",
                       GetSQLValueString($_POST['Login_id'], "text"),
                       GetSQLValueString($_POST['Management_fee'], "text"),
                       GetSQLValueString($_POST['Paid_management_fee'], "text"),
                       GetSQLValueString($_POST['Money_collection_person'], "text"),
...
$colname_cn_member = "-1";
if (isset($_GET['Id'])) {
  $colname_cn_member = $_GET['Id'];
}
mysql_select_db($database_cn_tanzi, $cn_tanzi);
$query_cn_member = sprintf("SELECT * FROM member WHERE Id = %s", GetSQLValueString($colname_cn_member, "int"));
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/less.js/2.7.1/less.js"></script>
        ...
        <div class="box">
            ...
            <div id="collapse4" class="body">
              <form action="<?php echo $editFormAction; ?>" id="management_fee_edit" name="management_fee_edit" method="POST">
                <table width="70%" border="0" cellspacing="0" cellpadding="0">
                  <tbody>
                    <tr>
                      <td><label for="Login_id">住戶帳號:</label>
                      <input name="Login_id" type="text" id="Login_id" value="<?php echo $row_cn_member['Login_id']; ?>"></td>
                    </tr>
                    <tr>
                      <td><label for="Management_fee">需繳交管理費:</label>
                      <input name="Management_fee" type="text" id="Management_fee" value="<?php echo $row_cn_member['Management_fee']; ?>"></td>
                    </tr>
                    <tr>
                      <td><label for="Paid_management_fee">已繳交管理費:</label>
                      <input name="Paid_management_fee" type="text" id="Paid_management_fee" value="<?php echo $row_cn_member['Paid_management_fee']; ?>"></td>
                    </tr>
                    <tr>
                      <td><label for="Money_collection_person">收款管理委員:</label>
                      <input name="Money_collection_person" type="text" id="Money_collection_person" value="<?php echo $row_cn_member['Money_collection_person']; ?>"></td>
                    </tr>
                    <tr>
                      <td><label for="Paid_date">繳交日期:</label>
                      <input name="Paid_date" type="text" id="Paid_date" value="<?php echo $row_cn_member['Paid_date']; ?>"></td>
                    </tr>
                ...
                <input name="Id" type="hidden" id="Id" form="management_fee_edit" value="<?php echo $row_cn_member['Id']; ?>">
                <input type="hidden" name="MM_update" value="management_fee_edit">
              </form>
              <p>&nbsp;</p>
