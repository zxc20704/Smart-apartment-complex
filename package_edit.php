...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "thing_edit")) {
  $updateSQL = sprintf("UPDATE package SET Package_mail=%s, Delivery_company=%s, `Date`=%s, Detail=%s WHERE Id=%s",
                       GetSQLValueString($_POST['Package_mail'], "text"),
                       GetSQLValueString($_POST['Delivery_company'], "text"),
...
$colname_cn_package = "-1";
if (isset($_GET['Id'])) {
  $colname_cn_package = $_GET['Id'];
}
mysql_select_db($database_cn_tanzi, $cn_tanzi);
$query_cn_package = sprintf("SELECT * FROM package WHERE Id = %s", GetSQLValueString($colname_cn_package, "int"));
$cn_package = mysql_query($query_cn_package, $cn_tanzi) or die(mysql_error());
$row_cn_package = mysql_fetch_assoc($cn_package);
$totalRows_cn_package = mysql_num_rows($cn_package);
?>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/less.js/2.7.1/less.js"></script>
        ...
        <div class="box">
            ...
            <div id="collapse4" class="body">
              <form action="<?php echo $editFormAction; ?>" id="package_edit" name="thing_edit" method="POST">
                <table width="70%" border="0" cellspacing="0" cellpadding="0">
                  <tbody>
                    <tr>
                      <td><label for="Package_mail">包裹、郵件:</label>
                       <select name="Package_mail" type="text"  id="select-form">
                        <option>請選擇</option>
                        <option>包裹</option>
                        <option>郵件</option>
                    ...
                    <tr>
                      <td><label for="Delivery_company">物流、運送公司:</label>
                      <input name="Delivery_company" type="text" id="Delivery_company" value="<?php echo $row_cn_package['Delivery_company']; ?>"></td>
                    </tr>
                    <tr>
                      <td><label for="Date">收到日期:</label>
                      <input name="Date" type="text" id="Date" value="<?php echo $row_cn_package['Date']; ?>"></td>
                    </tr>
                     <tr>
                      <td><label for="Detail">備註:</label>
                      <input name="Detail" type="text" id="Detail" value="<?php echo $row_cn_package['Detail']; ?>"></td>
                    </tr>
                ...
                <input name="Id" type="hidden" id="Id" form="package_edit" value="<?php echo $row_cn_package['Id']; ?>">
                <input type="hidden" name="MM_update" value="package_edit">
                <input type="hidden" name="MM_update" value="thing_edit">
