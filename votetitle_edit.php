...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "votetitle_edit")) {
  $updateSQL = sprintf("UPDATE votetitle SET voteTitle=%s, endDate=%s WHERE titleNo=%s",
                       GetSQLValueString($_POST['voteTitle'], "text"),
                       GetSQLValueString($_POST['endDate'], "date"),
                       GetSQLValueString($_POST['titleNo'], "int"));
...
$colname_cn_votetitle = "-1";
if (isset($_GET['titleNo'])) {
  $colname_cn_votetitle = $_GET['titleNo'];
}
mysql_select_db($database_cn_tanzi, $cn_tanzi);
$query_cn_votetitle = sprintf("SELECT * FROM votetitle WHERE titleNo = %s", GetSQLValueString($colname_cn_votetitle, "int"));
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/less.js/2.7.1/less.js"></script>
        ...
        <div class="box">
            ...
            <div id="collapse4" class="body">
              <form action="<?php echo $editFormAction; ?>" id="votetitle_edit" name="votetitle_edit" method="POST">
                <table width="70%" border="0" cellspacing="0" cellpadding="0">
                  <tbody>
                    <tr>
                      <td><label for="voteTitle">標題:</label>
                      <input name="voteTitle" type="text" id="voteTitle" value="<?php echo $row_cn_votetitle['voteTitle']; ?>"></td>
                    </tr>
                    
                    <tr>
                      <td><label for="endDate">結束時間:</label>
                      <input name="endDate" type="date" id="endDate" value="<?php echo $row_cn_votetitle['endDate']; ?>"></td>
                    </tr>
                ...
                <input name="titleNo" type="hidden" id="titleNo" form="votetitle_edit" value="<?php echo $row_cn_votetitle['titleNo']; ?>">
                <input type="hidden" name="MM_update" value="votetitle_edit">
              </form>
              <p>&nbsp;</p>
