...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "member_edit")) {
  $updateSQL = sprintf("UPDATE member SET Login_id=%s, Password=%s, Name=%s WHERE Id=%s",
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/less.js/2.7.1/less.js"></script>
        ...
        <div class="box">
            ...
            <div id="collapse4" class="body">
              <form action="<?php echo $editFormAction; ?>" id="member_edit" name="member_edit" method="POST">
                <table width="70%" border="0" cellspacing="0" cellpadding="0">
                  <tbody>
                    ...
                    <tr>
                      <td><label for="Password">用戶密碼:</label>
                      <input name="Password" type="text" id="Password" value="<?php echo $row_cn_member['Password']; ?>"></td>
                    </tr>
                    <tr>
                      <td><label for="Name">用戶暱稱:</label>
                      <input name="Name" type="text" id="Name" value="<?php echo $row_cn_member['Name']; ?>"></td>
                    </tr>
                ...
                <input name="Id" type="hidden" id="Id" form="member_edit" value="<?php echo $row_cn_member['Id']; ?>">
                <input type="hidden" name="MM_update" value="member_edit">
              </form>
              <p>&nbsp;</p>
