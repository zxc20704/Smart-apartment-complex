    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/less.js/2.7.1/less.js"></script>
        ...
        <div class="box">
            <header>
              ...
              <h5>公共設施簡介-健身房</h5>
              <h5><a href="property_add.php">新增</a></h5>
            </header>
            <div id="collapse4" class="body">
                    ...
                    <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td><?php echo $i; $i++; ?></td>
                          <td><?php echo $row_fitness['Name']; ?></td>
                          <td><?php echo $row_fitness['Class_picture']; ?></td>
                          <td><?php echo $row_fitness['Reserve_property']; ?></td>
                          <td><?php echo $row_fitness['Project']; ?></td>
                          <td><a href="property_fitness_edit.php?Id=<?php echo $row_fitness['Id']; ?>">修改</a></td>
                          <td><a href="property_del.php?Id=<?php echo $row_fitness['Id']; ?>">刪除</a></td>
                        </tr>
                        <?php } while ($row_fitness = mysql_fetch_assoc($sql_fitness)); ?>
                  </tbody>                </table>
            ...
            <div id="collapse4" class="body">
                    ...
                    <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td><?php echo $i; $i++;?></td>
                          <td><?php echo $row_play['Name']; ?></td>
                          <td><?php echo $row_play['Class_picture']; ?></td>
                          <td><?php echo $row_play['Reserve_property']; ?></td>
                          <td><?php echo $row_play['Project']; ?></td>
                          <td><a href="property_play_edit.php?Id=<?php echo $row_play['Id']; ?>">修改</a></td>
                          <td><a href="property_del.php?Id=<?php echo $row_play['Id']; ?>">刪除</a></td>
                        </tr>
                        <?php } while ($row_play = mysql_fetch_assoc($sql_play)); ?>
                  </tbody>                </table>
