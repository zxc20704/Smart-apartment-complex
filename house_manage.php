...
<div class="btn-group">
        ...
        <div class="box">
            <header>
              ...
              <h5>房屋出租管理-房屋出租首頁資訊</h5>
              <h5><a href="house_manage_detail.php">房屋詳細頁面資訊</a></h5>
                  ...
                  <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                    ...
                    <?php $i=1; do { 
                      ...
                      <tr>
                        ...
                        <td><?php echo $row_cn_house['Member']; ?></td>
                        <td><?php echo $row_class['Class_name']; ?></td>
                        <td><?php echo $row_cn_house['Pings']; ?></td>
                        <td><?php echo $row_cn_house['Price']; ?></td>
