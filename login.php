...
if (isset($_POST['Login_id'])) {
  ...
  $MM_redirectLoginSuccess = "index_back.php";
    ...
    <div class="tab-content">
        <div id="login" class="tab-pane active">
            <form ACTION="<?php echo $loginFormAction; ?>" METHOD="POST" id="login">
                ...
                <input name="Login_id" type="text" class="form-control top" id="login_id" placeholder="Username">
                <input name="Passward" type="password" class="form-control bottom" id="Passward" placeholder="Password">
                <div class="checkbox">
		  <label>
