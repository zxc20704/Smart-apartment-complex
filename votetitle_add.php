...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "votetitle_add")) {
  $insertSQL = sprintf("INSERT INTO votetitle (voteTitle, startDate, endDate) VALUES (%s, %s, %s)",
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/less.js/2.7.1/less.js"></script>
        ...
        <div class="box">
            ...
            <div id="collapse4" class="body">
              <form action="<?php echo $editFormAction; ?>" id="votetitle_add" name="votetitle_add" method="POST">
                <table width="70%" border="0" cellspacing="0" cellpadding="0">
                  <tbody>
                    <tr>
                      <td><label for="voteTitle">標題:</label>
                      <input type="text" name="voteTitle" id="voteTitle"></td>
                    </tr>
                ...
                <p>
                  ...
                  <input name="startDate" type="hidden" id="startDate" value="<?php echo date('Y-m-d'); ?>">
                </p>
                <p>&nbsp;</p>
                <input type="hidden" name="MM_insert" value="votetitle_add">
              </form>
              <p>&nbsp;</p>
