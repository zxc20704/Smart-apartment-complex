...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "message_edit")) {
  $updateSQL = sprintf("UPDATE board_main SET subject=%s, adminans=%s WHERE `no`=%s",
                       GetSQLValueString($_POST['subject'], "text"),
                       GetSQLValueString($_POST['adminans'], "text"),
...
$colname_cn_board_main = "-1";
if (isset($_GET['no'])) {
  $colname_cn_board_main = $_GET['no'];
}
mysql_select_db($database_cn_tanzi, $cn_tanzi);
$query_cn_board_main = sprintf("SELECT * FROM board_main WHERE `no` = %s", GetSQLValueString($colname_cn_board_main, "int"));
$cn_board_main = mysql_query($query_cn_board_main, $cn_tanzi) or die(mysql_error());
$row_cn_board_main = mysql_fetch_assoc($cn_board_main);
$totalRows_cn_board_main = mysql_num_rows($cn_board_main);
?>
<!doctype html>
<html>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/less.js/2.7.1/less.js"></script>
        ...
        <div class="box">
            ...
            <div id="collapse4" class="body">
              <form action="<?php echo $editFormAction; ?>" id="message_edit" name="message_edit" method="POST">
                <table width="70%" border="0" cellspacing="0" cellpadding="0">
                  <tbody>
                    <tr>
                      <td><label for="subject">標題:</label>
                      <input name="subject" type="text" id="subject" value="<?php echo $row_cn_board_main['subject']; ?>"></td>
                    </tr>
                    
                    <tr>
                      <td><label for="adminans">管理員回復:</label>
                      <textarea id="adminans" class="ckeditor" name="adminans" value="<?php echo $row_cn_board_main['adminans']; ?>"><?php echo $row_cn_board_main['adminans']; ?></textarea>
                ...
                <input name="no" type="hidden" id="no" form="message_edit" value="<?php echo $row_cn_board_main['no']; ?>">
                <input type="hidden" name="MM_update" value="message_edit">
              </form>
              <p>&nbsp;</p>
...
mysql_free_result($cn_board_main);
?>
