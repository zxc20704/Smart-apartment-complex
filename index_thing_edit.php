...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "thing_edit")) {
  $updateSQL = sprintf("UPDATE thing SET Title=%s, Thing=%s, Detail=%s WHERE Id=%s",
