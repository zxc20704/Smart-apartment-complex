...
mysql_select_db($database_cn_tanzi, $cn_tanzi);
$query_cn_member_photo = "SELECT * FROM member_photo ORDER BY Login_id ASC";
            ...
            <div id="collapse4" class="body">
                    ...
                    <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td><?php echo $i; $i++; ?></td>
                          <td><?php echo $row_cn_member_photo['Login_id']; ?></td>                         
                          <td><?php echo $row_cn_member_photo['Img_name']; ?></td>
                          <td><?php $FileDir=$row_cn_member_photo['Login_id'];    // 根據路徑下與用戶帳號相同的名稱 讀取資料夾下的圖片數
                                    $FileNum=count(glob("$FileDir/*.*"));
                                    echo $FileNum; ?></td> 
                                        
                          <td><a href="residents_manage_view_photo_manage.php?Img_name=<?php echo $row_cn_member_photo['Img_name']; ?>">查看</a></td>    
                          <td><a href="residents_manage_view_photo_examine.php?Img_name=<?php echo $row_cn_member_photo['Img_name']; ?>">查看</a></td>                                                
                          <td><?php echo $row_cn_member_photo['date']; ?></td>
                              
                        
                     </tr>
                        <?php } while ($row_cn_member_photo = mysql_fetch_assoc($cn_member_photo)); ?>
                  </tbody>                </table>
