...
?>
<?php 
$login_id_package=$_SESSION['MM_Username'];
$sql_package=mysql_query("SELECT * FROM `package` WHERE `Member_id`=$login_id_package "); 
...
<html>
    <head>
        ...
        <style>
            body{
                background:url(travel/背景_5.jpg);
            }
            #wrapper{
                width: 100%;
                margin: 0 auto;
              ...
              <div class="col-md-12 col-lg-offset-2 col-lg-8">
                <div class="form-wrapper">
                  <div class="from-header">
                    <h1>包裹、郵件</h1>
                    <h3><p>如果有您的包裹或郵件寄到警衛室，會記錄到此表格中。</p></h3>
                  </div>
                 ...
                 <br>
                    <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                      ...
                      <tbody>
                        <?php do {?>
                        <tr>
                          <td><?php echo $row_package['Package_mail']; ?></td>
                          <td><?php echo $row_package['Delivery_company']; ?></td>
                          <td><?php echo $row_package['Date']; ?></td>
                          <td><?php echo $row_package['Detail']; ?></td>
                         
                        </tr>
                        <?php } while ($row_package=mysql_fetch_array($sql_package)) ;?>
                  </tbody>                </table>
                  ...
                  <br>
                    ...
                    <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td><?php echo $row['Management_fee']; ?></td>
                          <td><?php echo $row['Paid_management_fee']; ?></td>
                          <td><?php echo $row['Paid_management_fee']; ?></td>
