...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "member_photo_edit")) {
  $updateSQL = sprintf("UPDATE member_photo SET Login_id=%s, qualifications=%s, checking=%s WHERE Id=%s",
                       GetSQLValueString($_POST['Login_id'], "text"),
                       GetSQLValueString($_POST['qualifications'], "text"),
                       GetSQLValueString($_POST['checking'], "text"),
                       GetSQLValueString($_POST['Id'], "int"));

  mysql_select_db($database_cn_tanzi, $cn_tanzi);
  $Result1 = mysql_query($updateSQL, $cn_tanzi) or die(mysql_error());

  $updateGoTo = "residents_manage.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$colname_cn_member_photo = "-1";
if (isset($_GET['Id'])) {
  $colname_cn_member_photo = $_GET['Id'];
}
mysql_select_db($database_cn_tanzi, $cn_tanzi);
$query_cn_member_photo = sprintf("SELECT * FROM member_photo WHERE Id = %s", GetSQLValueString($colname_cn_member_photo, "int"));
$cn_member_photo = mysql_query($query_cn_member_photo, $cn_tanzi) or die(mysql_error());
$row_cn_member_photo = mysql_fetch_assoc($cn_member_photo);
$totalRows_cn_member_photo = mysql_num_rows($cn_member_photo);
?>
<!doctype html>
<html>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/less.js/2.7.1/less.js"></script>
        ...
        <div class="box">
            ...
            <div id="collapse4" class="body">
              <form action="<?php echo $editFormAction; ?>" id="manage_edit" name="manage_edit" method="POST">
                <table width="70%" border="0" cellspacing="0" cellpadding="0">
                  <tbody>
                    <tr>
                      <td><label for="Login_id">用戶帳號:</label>
                      <input name="Login_id" type="text" id="Login_id" value="<?php echo $row_cn_member_photo['Login_id']; ?>"></td>
                    </tr>
                    <tr>
                      <td><label for="qualifications">是否合格:</label>
                      <input name="qualifications" type="text" id="qualifications" value="<?php echo $row_cn_member_photo['qualifications']; ?>"></td>
                    </tr>
                    <tr>
                      <td><label for="checking">有無審查:</label>
                      <input name="checking" type="text" id="checking" value="<?php echo $row_cn_member_photo['checking']; ?>"></td>
                    </tr>
                ...
                <input name="Id" type="hidden" id="Id" form="manage_edit" value="<?php echo $row_cn_member_photo['Id']; ?>">
                <input type="hidden" name="MM_update" value="manage_edit">
              </form>
              <p>&nbsp;</p>
...
mysql_free_result($cn_member_photo);
?>
