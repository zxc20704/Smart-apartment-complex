...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "fitness_edit")) {
  $updateSQL = sprintf("UPDATE property SET Name=%s, `Class`=%s, Class_picture=%s, Reserve_property=%s, Project=%s WHERE Id=%s",
                       GetSQLValueString($_POST['Name'], "text"),
                       GetSQLValueString($_POST['Class'], "text"),
                       GetSQLValueString($_POST['Class_picture'], "text"),
  ...
  $updateGoTo = "property_manage.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$colname_cn_property_fitness = "-1";
if (isset($_GET['Id'])) {
  $colname_cn_property_fitness = $_GET['Id'];
}
mysql_select_db($database_cn_tanzi, $cn_tanzi);
$query_cn_property_fitness = sprintf("SELECT * FROM property WHERE Id = %s", GetSQLValueString($colname_cn_property_fitness, "int"));
$cn_property_fitness = mysql_query($query_cn_property_fitness, $cn_tanzi) or die(mysql_error());
$row_cn_property_fitness = mysql_fetch_assoc($cn_property_fitness);
$totalRows_cn_property_fitness = mysql_num_rows($cn_property_fitness);
?>
<!doctype html>
<html>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/less.js/2.7.1/less.js"></script>
        ...
        <div class="box">
            ...
            <div id="collapse4" class="body">
              <form action="<?php echo $editFormAction; ?>" id="fitness_edit" name="fitness_edit" method="POST">
                <table width="70%" border="0" cellspacing="0" cellpadding="0">
                  <tbody>
                     <tr>
                      <td><label for="Name">設施名稱:</label>
                      <input type="text" name="Name" id="Name" value="<?php echo $row_cn_property_fitness['Name']; ?>"></td>
                    </tr>
                     <tr>
                      <td><label for="Class">設施類別:</label>
                       <select name="Class" type="text"  id="Class">
                    ...
                    <tr>
                      <td><label for="Class_picture">類別圖片:</label>
                      <input type="text" name="Class_picture" id="Class_picture" value="<?php echo $row_cn_property_fitness['Class_picture']; ?>"></td>
                    </tr>
                    <tr>
                      <td><label for="Reserve_property">是否可以預約:</label>
                      <input type="text" name="Reserve_property" id="Reserve_property" placeholder="" value="<?php echo $row_cn_property_fitness['Reserve_property']; ?>">&nbsp;[ 1:可以 / 0:不可以 ]</td>
                    </tr>
                    <tr>
                      <td><label for="Project">是否為公共設施簡介的項目:</label>
                      <input type="text" name="Project" id="Project" placeholder="" value="<?php echo $row_cn_property_fitness['Project']; ?>">&nbsp;[ 1:是 / 0:不是 ]</td>
                    </tr>
                ...
                <input name="Id" type="hidden" id="Id" form="fitness_edit" value="<?php echo $row_cn_property_fitness['Id']; ?>">
                <input type="hidden" name="MM_update" value="fitness_edit">
              </form>
              <p>&nbsp;</p>
...
mysql_free_result($cn_property_fitness);
?>
